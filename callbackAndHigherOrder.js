...
const printEach = (item, index) => console.log(`The item at index ${index} is ${item}`);
...
const getUserById = (users, id, callback) => {
  users.forEach((index, element) => {if (index.id === id){
    callback(index)
  }})
}
...
// CODE HERE
const addSeventeen = addingFactory(17);
console.log(addSeventeen(3));